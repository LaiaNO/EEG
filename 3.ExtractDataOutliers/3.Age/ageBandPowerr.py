...
def calcul(names, patientNames, TeiQueSF_emotionality, age, pacientData, yo, oy):
    savecor_1r = []
    savecor_2r = []
    savecor_3r = []
...
def plotbar_info_bandpower1(names, sorted_list_EO, TeiQueSF_emotionality, gender, list_bands):
    ...
    minus5_1, minus5_2, minus5_3 = minus_return_bandpower1(
        names, sorted_list_EO, TeiQueSF_emotionality, gender, list_bands)
    max_5_1, max_5_2, max_5_3 = max5_return_bandpower1(
        names, sorted_list_EO, TeiQueSF_emotionality, gender, list_bands)
    # print(minus5)
    str1Max, str2Max, str3Max = max5_return_str1(
        names, sorted_list_EO, TeiQueSF_emotionality, gender, list_bands)
    str1Min, str2Min, str3Min = min5_return_str1(
        names, sorted_list_EO, TeiQueSF_emotionality, gender, list_bands)
    ...
    fig, ax = plt.subplots()
    if len(minus5_1) > 0:
        rects1 = ax.bar(x-0.3, minus5_1, width, yerr=str1Min,
                        capsize=0.05, label='-4 1')
    if len(max_5_1) > 0:
        rects3 = ax.bar(x-0.2, max_5_1, width, yerr=str1Max,
                        capsize=0.05, label='+4 1')
    if len(minus5_2) > 0:
        rects4 = ax.bar(x-0.1, minus5_2, width, yerr=str2Min,
                        capsize=0.05, label='-4 2')
    if len(max_5_2) > 0:
        rects5 = ax.bar(x, max_5_2, width, yerr=str2Max,
                        capsize=0.05, label='+4 2')
    if len(minus5_3) > 0:
        rects2 = ax.bar(x+0.1, minus5_3, width, yerr=str3Min,
                        capsize=0.05, label='-4 3')
    if len(max_5_3) > 0:
        rects4 = ax.bar(x+0.2, max_5_3, width, yerr=str3Max,
                        capsize=0.05, label='+4 3')
...
def plotbar_info_rac(names, sorted_list_EO, TeiQueSF_emotionality, gender, list_bands):
    ...
    minus1, minus2, minus3 = minus_return_rac(
        names, sorted_list_EO, TeiQueSF_emotionality, gender, list_bands)
    max1, max2, max3 = max5_return_rac(
        names, sorted_list_EO, TeiQueSF_emotionality, gender, list_bands)
